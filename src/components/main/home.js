...
// const apiKey = '57cfb98a-52c7-49bb-95b8-2eae9702b3b1'
...
class home extends Component {
  ...
  componenDidMount() {
    ...
    axios.get('https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest', {
        headers: { 'X-CMC_PRO_API_KEY': '57cfb98a-52c7-49bb-95b8-2eae9702b3b1' }
    })
    .then(res => {
        console.log(res)
        this.setState({
      ...
      <div className='home_div footer_padding'>
        <div className='home_sub_div'>
          ...
          <div className='row card_all_div'>
            <div className='col-md-4 col-sm-4 card_div'>
              <div className='wallet'>
                ...
                <p className='wallet_date'>Last updated June 14, 2021, 12:00</p>
              </div>
            </div>
            <div className='col-md-4 col-sm-4 card_div card_div_tablet'>
              <div className='cards'>
                <div>
